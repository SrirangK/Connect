                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                      border: OutlineInputBorder(
                        ...
                        borderSide: BorderSide.none, // This ensures no border side is shown

                      ),
                      hintText: "Search groups....",
                      hintStyle: TextStyle(color: Colors.grey, fontSize: 16), // Changed hint color for better contrast
                    ),
                  ),
